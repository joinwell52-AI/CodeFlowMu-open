...
> [!NOTE]
> **📢 版本状态说明（Version Status）**
>
> 当前开源版本已进入维护冻结状态，不再进行新功能更新。
>
...
以下均为真实系统截图，不是概念效果图。当前应用版本为 `V1.2.29-open`；中文 PC 截图采集自正在运行的 `V1.2.6-open`；手机截图采集自真实 PWA V1.0.58，“本版更新”截图采集于 V1.0.59。
